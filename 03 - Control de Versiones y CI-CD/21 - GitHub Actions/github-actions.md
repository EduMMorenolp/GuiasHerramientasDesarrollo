...
**GitHub Actions** es la plataforma de CI/CD integrada en GitHub. Permite automatizar builds, tests, despliegues y cualquier flujo de trabajo mediante workflows definidos en YAML.
